...
{
    public class TestStandardVsMachineRepository : ITestStandardVsMachineRepository
    {
        private readonly RavenDBContext _db;
        public TestStandardVsMachineRepository(RavenDBContext db)
        {
            _db = db;
        }
        public SaveVM SaveTestStandardVsMachine(TestStandardVsMachineVM obj)
        {
            try
            {
                ...
                var result = _db.Database.SqlQuery<SaveVM>("InsertUpdateTestStandardVsMachine_SP  @ID,@TestStandardID,@MachineID,@IsActive,@Creator",
                    ID, TestStandardID, MachineID, isActive, Creator).FirstOrDefault();
        ...
        public IEnumerable<TestStandardVsMachineVM> GetTestStandardVsMachine()
        {
            ...
            var result = _db.Database.SqlQuery<TestStandardVsMachineVM>("GetTestStandardVsMachine_SP @ID", parms).ToList();
            return result;
        }
    }
}
